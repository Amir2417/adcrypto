        ...
        <div class="col-xl-6 col-lg-6 mb-20">
            <div class="custom-card">
                ...
                <div class="card-body">
                    ...
                    <p>{{ __("Google Authenticator adds an extra layer of security to your online accounts by adding a second step of verification when you sign in. This means that in addition to your password, you'll also need to enter a code that is generated by the Google Authenticator app on your phone.") }} <a data-rel="lightcase:myCollection" href="https://www.youtube.com/embed/7p6hG3plQj4" class="text--base">{{ __("How to Setup?") }}</a></p>
