...
class ExchangeCryptoMailNotification extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ...
            ->line("Fees & Charges: " . getAmount($data->data->total_charge).' '. $data->data->sender_wallet->name)
            ->line("Will Get: " . getAmount($data->data->get_amount,2).' '. $data->data->sender_wallet->name)
            ->line("Total Payable Amount: " . getAmount($data->data->payable_amount,2).' '. $data->data->sender_wallet->name)
